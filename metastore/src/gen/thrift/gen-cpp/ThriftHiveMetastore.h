...
class ThriftHiveMetastoreIf : virtual public  ::facebook::fb303::FacebookServiceIf {
 public:
  ...
  virtual void alter_partitions_for_tables(const std::string& db_name, const std::map<std::string, std::vector<Partition> > & tbl_parts) = 0;
...
class ThriftHiveMetastoreNull : virtual public ThriftHiveMetastoreIf , virtual public  ::facebook::fb303::FacebookServiceNull {
 public:
  ...
  void alter_partitions_for_tables(const std::string& /* db_name */, const std::map<std::string, std::vector<Partition> > & /* tbl_parts */) {
    return;
  }
...
typedef struct _ThriftHiveMetastore_alter_partitions_for_tables_args__isset {
  _ThriftHiveMetastore_alter_partitions_for_tables_args__isset() : db_name(false), tbl_parts(false) {}
  bool db_name;
  bool tbl_parts;
} _ThriftHiveMetastore_alter_partitions_for_tables_args__isset;

class ThriftHiveMetastore_alter_partitions_for_tables_args {
 public:

  ThriftHiveMetastore_alter_partitions_for_tables_args() : db_name() {
  }

  virtual ~ThriftHiveMetastore_alter_partitions_for_tables_args() throw() {}

  std::string db_name;
  std::map<std::string, std::vector<Partition> >  tbl_parts;

  _ThriftHiveMetastore_alter_partitions_for_tables_args__isset __isset;

  void __set_db_name(const std::string& val) {
    db_name = val;
  }

  void __set_tbl_parts(const std::map<std::string, std::vector<Partition> > & val) {
    tbl_parts = val;
  }

  bool operator == (const ThriftHiveMetastore_alter_partitions_for_tables_args & rhs) const
  {
    if (!(db_name == rhs.db_name))
      return false;
    if (!(tbl_parts == rhs.tbl_parts))
      return false;
    return true;
  }
  bool operator != (const ThriftHiveMetastore_alter_partitions_for_tables_args &rhs) const {
  ...
  bool operator < (const ThriftHiveMetastore_alter_partitions_for_tables_args & ) const;
...
class ThriftHiveMetastore_alter_partitions_for_tables_pargs {
 public:


  virtual ~ThriftHiveMetastore_alter_partitions_for_tables_pargs() throw() {}

  const std::string* db_name;
  const std::map<std::string, std::vector<Partition> > * tbl_parts;

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _ThriftHiveMetastore_alter_partitions_for_tables_result__isset {
  _ThriftHiveMetastore_alter_partitions_for_tables_result__isset() : o1(false), o2(false) {}
  bool o1;
  bool o2;
} _ThriftHiveMetastore_alter_partitions_for_tables_result__isset;

class ThriftHiveMetastore_alter_partitions_for_tables_result {
 public:

  ThriftHiveMetastore_alter_partitions_for_tables_result() {
  }

  virtual ~ThriftHiveMetastore_alter_partitions_for_tables_result() throw() {}

  InvalidOperationException o1;
  MetaException o2;

  _ThriftHiveMetastore_alter_partitions_for_tables_result__isset __isset;
  ...
  bool operator == (const ThriftHiveMetastore_alter_partitions_for_tables_result & rhs) const
  {
    if (!(o1 == rhs.o1))
      return false;
    if (!(o2 == rhs.o2))
  ...
  bool operator < (const ThriftHiveMetastore_alter_partitions_for_tables_result & ) const;
...
typedef struct _ThriftHiveMetastore_alter_partitions_for_tables_presult__isset {
  _ThriftHiveMetastore_alter_partitions_for_tables_presult__isset() : o1(false), o2(false) {}
  bool o1;
  bool o2;
} _ThriftHiveMetastore_alter_partitions_for_tables_presult__isset;

class ThriftHiveMetastore_alter_partitions_for_tables_presult {
 public:


  virtual ~ThriftHiveMetastore_alter_partitions_for_tables_presult() throw() {}

  InvalidOperationException o1;
  MetaException o2;

  _ThriftHiveMetastore_alter_partitions_for_tables_presult__isset __isset;
...
class ThriftHiveMetastoreClient : virtual public ThriftHiveMetastoreIf, public  ::facebook::fb303::FacebookServiceClient {
 public:
  ...
  void alter_partitions_for_tables(const std::string& db_name, const std::map<std::string, std::vector<Partition> > & tbl_parts);
  void send_alter_partitions_for_tables(const std::string& db_name, const std::map<std::string, std::vector<Partition> > & tbl_parts);
  void recv_alter_partitions_for_tables();
  void alter_partition_with_environment_context(const std::string& db_name, const std::string& tbl_name, const Partition& new_part, const EnvironmentContext& environment_context);
...
class ThriftHiveMetastoreProcessor : public  ::facebook::fb303::FacebookServiceProcessor {
 ...
 private:
  ...
  void process_alter_partitions_for_tables(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 ...
 public:
  ThriftHiveMetastoreProcessor(boost::shared_ptr<ThriftHiveMetastoreIf> iface) :
    ...
    processMap_["alter_partitions_for_tables"] = &ThriftHiveMetastoreProcessor::process_alter_partitions_for_tables;
...
class ThriftHiveMetastoreMultiface : virtual public ThriftHiveMetastoreIf, public  ::facebook::fb303::FacebookServiceMultiface {
 ...
 public:
  ...
  void alter_partitions_for_tables(const std::string& db_name, const std::map<std::string, std::vector<Partition> > & tbl_parts) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->alter_partitions_for_tables(db_name, tbl_parts);
    }
    ifaces_[i]->alter_partitions_for_tables(db_name, tbl_parts);
  }
